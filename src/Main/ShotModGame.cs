    ...
    : GameWindow(gameWindowSettings, nativeWindowSettings)
{
    ...
    private ShotMaterial _cubeMat = default!;
    private ShotMaterial _lightMat = default!;
    ...
    protected override void OnRenderFrame(FrameEventArgs e)
    {
        ...
        var cubeModel = Matrix4.Identity * Matrix4.CreateTranslation(_lightPos.Sys2OpenTk()) * Matrix4.CreateScale(0.4f);
        var lightModel = Matrix4.Identity * Matrix4.CreateTranslation(0, 0, 3);
